      ...
      <div className="app__services2">
        <div className="left">
          <div className="left-img">
            <img src={images.horizontal0} alt="left-img" />
          </div>
          <div className="left-text">
            <h3>الشحن الجوي</h3>
          </div>
          <div className="left-img">
            <img src={images.horizontal4} alt="left-img" />
          </div>
          <div className="left-text">
            <h3>الشحن البري</h3>
          </div>
        ...
        <div className="right">
          ...
          <div className="right-img">
            <img src={images.horizontal1} alt="left-img" />
          </div>
          <div className="right-text">
            <h3>الشحن البحري</h3>
          </div>
          <div className="right-img">
            <img src={images.horizontal2} alt="left-img" />
          </div>
        </div>
      </div>
    </>
